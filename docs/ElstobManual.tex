...
3. \cvd[1]{38}{s} (narrow long s). Instances of \textbf{\cvd[1]{38}{s}}
provided by this feature are not subject to the contextual rules followed
when ss08 is turned on. Use cv38[1] for \textbf{\cvd[1]{38}{s}}
everywhere in the text, or enter U+017F directly for fine control over the
distribution of \textbf{\cvd[1]{38}{s}}. Use cv38[2] to avoid collisions that
...
\textsc{zero-width non-joiner }{\spaced\addfontfeature{StylisticSet=18}(U+200C) anywhere between the period and the capital
