...
marks; and (2.) substituting ligatures for certain vowel + rhotic hook (\ltab{U+02DE})
combinations.
...
This feature also affects \ltab{U+01E3} (\textit{\cvd{57}{ǣ}})
and \ltab{U+01FD} (\textit{\cvd{57}{ǽ}}).

\section{cv69 (Variants of Tironian et sign ⁊)}
Provides two variants of \ltab{U+204A}: 1. \cvd{69}{⁊}; 2. \cvd[1]{69}{⁊}.
...
{\addfontfeatures{Ligatures=Historic} þþ ƿƿ hh} for
{\addfontfeatures{Language=English}þþ ƿƿ hh}. The first two of these correspond
to Unicode \ltab{U+A7D3 and U+A7D5}, but using the ligatures provides an intelligible
...
(\addfontfeature{Language=English}{Þ þ ð}) when English is the
active language.
...
dfgirstw → {\addfontfeature{StylisticSet=2} dfgirstw}. Note that calt later
...
\ltab{U+200C} \textsc{zero-width non-joiner} or any invisible formatting mark
between the \textbf{s} and the \textbf{t}.

\section{ss04 (IPA Letter-Shapes)}
Changes g to ɡ and (in italic only)
\textit{a} to \textit{\addfontfeature{StylisticSet=4} a}. This feature has no counterpart in
Junicode.
...
\cvd[1]{36}{r} in accordance with the rules most often employed in medieval manuscripts and early printed books: {\addfontfeature{StylisticSet=16} form workrooms priest prayer}.
...
Ꜻ & a73a & \fstr{LATIN CAPITAL LETTER AV WITH HORIZONTAL BAR}\\\hline
...
Ǻ & 01fa & \fstr{LATIN CAPITAL LETTER A WITH RING ABOVE AND ACUTE}\\\hline
...
Ꝋ & a74a & \fstr{LATIN CAPITAL LETTER O WITH LONG STROKE OVERLAY}\\\hline
...
Ǿ & 01fe & \fstr{LATIN CAPITAL LETTER O WITH STROKE AND ACUTE}\\\hline
...
Ꝙ & a758 & \fstr{LATIN CAPITAL LETTER Q WITH DIAGONAL STROKE}\\\hline
...
ǻ & 01fb & \fstr{LATIN SMALL LETTER A WITH RING ABOVE AND ACUTE}\\\hline
...
ɝ & 025d & \fstr{LATIN SMALL LETTER REVERSED OPEN E WITH HOOK}\\\hline
...
ʢ & 02a2 & \fstr{LATIN LETTER REVERSED GLOTTAL STOP WITH STROKE}\\\hline
...
ʮ & 02ae & \fstr{LATIN SMALL LETTER TURNED H WITH FISHHOOK}\\\hline
ʯ & 02af & \ffstr{LATIN SMALL LETTER TURNED H WITH FISHHOOK AND TAIL}\\\hline
...
ʄ & 0284 & \fstr{LATIN SMALL LETTER DOTLESS J WITH STROKE AND HOOK}\\\hline
...
ẜ & 1e9c & \fstr{LATIN SMALL LETTER LONG S WITH DIAGONAL STROKE}\\\hline
...
ꝋ & a74b & \fstr{LATIN SMALL LETTER O WITH LONG STROKE OVERLAY}\\\hline
...
ꝑ & a751 & \ffstr{LATIN SMALL LETTER P WITH STROKE THROUGH DESCENDER}\\\hline
...
ꝗ & a757 & \ffstr{LATIN SMALL LETTER Q WITH STROKE THROUGH DESCENDER}\\\hline
...
ɿ & 027f & \fstr{LATIN SMALL LETTER REVERSED R WITH FISHHOOK}\\\hline
...
« & 00ab & \fstr{LEFT-POINTING DOUBLE ANGLE QUOTATION MARK}\\\hline
» & 00bb & \fstr{RIGHT-POINTING DOUBLE ANGLE QUOTATION MARK}\\\hline
‹ & 2039 & \fstr{SINGLE LEFT-POINTING ANGLE QUOTATION MARK}\\\hline
› & 203a & \fstr{SINGLE RIGHT-POINTING ANGLE QUOTATION MARK}\\\hline
...
◌ᷓ & 1dd3 & \ffstr{COMBINING LATIN SMALL LETTER FLATTENED OPEN A ABOVE}\\\hline
